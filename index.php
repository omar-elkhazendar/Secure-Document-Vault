                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <blockquote class="blockquote text-center">
                                    ...
                                    <footer class="blockquote-footer mt-2">Omar Magdy, <cite title="Source Title">System Admin</cite></footer>
                                </blockquote>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <blockquote class="blockquote text-center">
                                    ...
                                    <footer class="blockquote-footer mt-2">Omar Magdy, <cite title="Source Title">Legal Counsel</cite></footer>
                                </blockquote>
                            </div>
                        </div>
                    </div>
